...
if(!empty($_POST["login"]))
{
        ...
        $query = "INSERT INTO baduser (name,password) VALUES ('$name','$password')";
			...
			//header("Location: http://ec2-54-201-219-185.us-west-2.compute.amazonaws.com/index.php");
                }
                else
                {
                        echo "Error: " . $sql . "<br>" . $conn->error;
			header("Location: malicious.php");
			//header("Location:http://ec2-54-201-219-185.us-west-2.compute.amazonaws.com/malicious.php");
                }
$conn->close();
...
if (!empty($_POST["update"]))
{
	$id=$_POST['id'];
        ...
        $query = "UPDATE user set name='$name', email='$email',password='$password',handphone='$handphone',address='$address',creditno='$creditno',code='$code'	WHERE id='$id'";
                if ($conn->query($query) === TRUE)
                {
                        echo "New record created successfully";
                }
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<?php
                                                ...
                                                {
                                                        echo '<li class=" menu__item"><a class="menu__link" href="profile.php?user='.$_SESSION['name'].'">My Profile</a></li>';
                                                }
                                        ?>
...
<br>
<br>
<p style="text-align:center"><font size="50">My Profile</font></p>
...
while($row=mysqli_fetch_row($result))   //from the database, fetch the data and display out.
{
	echo "<table align='center' border='5' style=width:30%>";	
	echo "<tr><td align=left>ID: ".$row[0]."</td></tr>";				//Call out the data of ID from database
	echo "<tr><td align=left>Name: ".$row[1]."</td></tr>";			//Call out the data of question from database
	echo "<tr><td align=left>Password: ".$row[3]."</td></tr>";			//Call out the data of matric from database
	echo "<tr><td align=left>Email: ".$row[2]."</td></tr>";				//Call out the data of name from database
	echo "<tr><td align=left>Handphone: ".$row[4]."</td></tr>";			//Call out the data of contact from database
	echo "<tr><td align=left>Address: ".$row[5]."</td></tr>";				//Call out the data of email from database
        echo "<tr><td align=left>Credit Number: ".$row[6]."</td></tr>";
        echo "<tr><td align=left>Code: ".$row[7]."</td></tr>";
	echo '<tr><td align=center><a href="#">Edit Profile!</a></td></tr>';
	echo "</table>";
}
?>
