				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<?php
                                                ...
                                                {
                                                        echo '<li class=" menu__item"><a class="menu__link" href="profile.php?user='.$_SESSION['name'].'">Your Profile</a></li>';
                                                }
                                        ?>
...
<?php
$query = $con->prepare("SELECT message from contact ORDER BY id DESC LIMIT 1");
...
{
	echo "<p style=\"color: #fff;\">Your Message: " . $Message . " has been recorded<p><br>" ;
        $i++;
}
?>
